...
//this says if player is in 'drop area' and they press the right key, they will pick up object
	void Update(){
		...
		if(playerInTrigger && Input.GetButtonDown("Submit1") && item.transform.IsChildOf(tempParent.transform)){
		...
		else if(playerInTrigger && Input.GetButtonDown("Submit1") && item1.transform.IsChildOf(tempParent.transform)){
		...
		else if(playerInTrigger && Input.GetButtonDown("Submit1") && item2.transform.IsChildOf(tempParent.transform)){
		...
		else if(playerInTrigger && Input.GetButtonDown("Submit1") && item3.transform.IsChildOf(tempParent.transform)){
		...
		else if(playerInTrigger && Input.GetButtonDown("Submit1") && item4.transform.IsChildOf(tempParent.transform)){
		...
		else if(playerInTrigger && Input.GetButtonDown("Submit1") && item5.transform.IsChildOf(tempParent.transform)){
		...
		else if(playerInTrigger && Input.GetButtonDown("Submit1") && item6.transform.IsChildOf(tempParent.transform)){
		...
		else if(playerInTrigger && Input.GetButtonDown("Submit1") && item7.transform.IsChildOf(tempParent.transform)){
		...
		else if(playerInTrigger && Input.GetButtonDown("Submit1") && item8.transform.IsChildOf(tempParent.transform)){
		...
		else if(playerInTrigger && Input.GetButtonDown("Submit1") && item9.transform.IsChildOf(tempParent.transform)){
		...
		else if(playerInTrigger && Input.GetButtonDown("Submit1") && item10.transform.IsChildOf(tempParent.transform)){
		...
		else if(playerInTrigger && Input.GetButtonDown("Submit1") && item11.transform.IsChildOf(tempParent.transform)){
		...
		else if(playerInTrigger && Input.GetButtonDown("Submit1") && item12.transform.IsChildOf(tempParent.transform)){
